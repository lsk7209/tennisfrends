...
export const STYLE_QUESTIONS: StyleQuestion[] = [
  ...
  {
    id: 6,
    question: "코트 커버와 수비 전환은?",
    options: [
      { label: "한두 번 더 넘겨 실수를 유도", score: { CP: 3 } },
      { label: "상황 맞춤 포지셔닝으로 부담 분산", score: { AC: 3 } },
      { label: "상대 즐겨 쓰는 구간을 미리 봉쇄", score: { TAC: 3 } },
      { label: "짧아진 볼에서 즉시 역공 전환", score: { ABL: 2, FSA: 1 } },
      { label: "수비 안정이 먼저, 반격은 상황 보고", score: { CONS: 3 } }
    ]
  },
  {
    id: 7,
  ...
  {
    id: 8,
    question: "상대가 백핸드를 집요하게 공략할 때?",
    options: [
      { label: "길게 버티며 반대 코스로 전환 타이밍 노림", score: { CP: 3 } },
      { label: "실수 최소화를 위해 스핀/높이로 안정 추구", score: { CONS: 3 } },
      { label: "스텝-인 후 라인 체인지로 패턴 붕괴", score: { TAC: 3 } },
      { label: "드라이브로 밀어붙여 주도권 유지", score: { ABL: 2 } },
      { label: "슬라이스 혼합으로 템포 교란", score: { AC: 3 } }
    ]
  },
  {
    id: 9,
  ...
  {
    id: 13,
    question: "애매한 볼에서 당신의 선택은?",
    options: [
      { label: "강하게 밀어붙여 찬스로 만든다", score: { ABL: 3, FSA: 1 } },
      { label: "각과 스핀으로 포지션 이동 유도", score: { TAC: 3 } },
      { label: "오류를 피할 안전한 코스로 연결", score: { CONS: 3 } },
      { label: "드롭/슬라이스로 템포 흔들기", score: { TAC: 2, AC: 1 } },
      { label: "상황 따라 스위치", score: { AC: 3 } }
    ]
  },
  {
    id: 14,
    question: "복식에서 선호하는 포지셔닝은?",
    options: [
      { label: "서브-발리/리턴-발리 적극 활용", score: { SV: 3 } },
      { label: "상대 패턴 읽고 아이포/오스트리안 혼합", score: { TAC: 3 } },
      { label: "베이스-네트 균형으로 공간 관리", score: { AC: 3 } },
      { label: "리스크 줄이는 후방 커버", score: { CONS: 2, CP: 1 } },
      { label: "초구에 공격 전개로 단타 유도", score: { FSA: 2 } }
    ]
  },
  {
    id: 15,
    question: "선호하는 랠리 길이는?",
    options: [
      { label: "짧게 끝나는 포인트", score: { FSA: 3, ABL: 1 } },
      { label: "중간 정도, 기회 나오면 끝낸다", score: { AC: 3 } },
      { label: "길어도 상관없다, 실수 유도", score: { CP: 2, CONS: 1 } },
      { label: "길이보다 패턴 완성이 중요", score: { TAC: 3 } },
      { label: "실수 적은 쪽이 이긴다", score: { CONS: 3 } }
    ]
  },
  {
    id: 16,
  ...
  {
    id: 17,
    question: "체력 관점에서의 플레이 철학은?",
    options: [
      { label: "긴 랠리와 수비 전환도 자신", score: { CP: 2, CONS: 1 } },
      { label: "짧은 라운드에서 효율적 득점", score: { FSA: 2, ABL: 1 } },
      { label: "네트로 빨리 끝내 체력 분산", score: { SV: 3 } },
      { label: "상황 적응으로 체력 관리", score: { AC: 3 } },
      { label: "패턴 완성에 필요한 체력 우선", score: { TAC: 3 } }
    ]
  },
  {
    id: 18,
